...
// ====== 공정 데이터 업로드 설정 ======
#define ENABLE_API_UPLOAD         0                     // 0으로 두면 업로드 비활성화
#define API_ENDPOINT_URL          "http://13.125.246.193/services/processData"
#define API_HEADER_SECURITY_KEY   "Security"
#define API_HEADER_SECURITY_VALUE "089d3f1ad4cb11afcf4d2a4fb567ff3ceca2fecce86b492b673707fc1f6d8c94"
#define API_PRODUCT_ID            "1006"
#define API_PARTNER_ID            "1001"
#define API_MACHINE_ID            "1008"
#define API_RECORD_ID             "1054"              // 필요 시 서버 요구사항에 맞게 변경
#define API_DEPARTURE_YN          "n"
